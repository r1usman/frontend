...
const getAllComments = async () => {
    try {
        const response = await AxiosInstance.get(API_PATH.COMMENTS.GET_ALL_COMMENTS);
...
const deleteComment = async (commentId) => {
    try {
        const response = await AxiosInstance.delete(API_PATH.COMMENTS.DELETE_COMMENT(commentId));
        getAllComments();
    } catch (error) {
        console.log(error);
