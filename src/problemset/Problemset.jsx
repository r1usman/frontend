...
//         code: problem._id,
//         name: problem.name,
//         submissions: 0, // API doesn't provide this, you may need to add it
...
//   // Search handler (you'll need to add a search input)
...
//       setLoading(true);
//       setError(null);
//       const response = await problemsApi.searchProblems(query);
...
//                   <p className="text-3xl font-bold text-gray-900">{allProblems.length}</p>
//                 </div>
