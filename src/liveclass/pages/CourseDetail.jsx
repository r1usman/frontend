              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-white/80">Active Course</span>
                  </div>
                </div>
              </div>
              <div className="ml-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="px-6 py-4 bg-purple-500/70">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center space-x-4">
                          <div className="w-12 h-12 bg-purple-500/70 rounded-full flex items-center justify-center">
                        ...
                        <button
                          ...
                          className={`px-6 py-2 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2 ${
                            isEnrolled
                              ...
                              : "bg-purple-500/70 hover:bg-purple-500 text-white hover:scale-105"
                          }`}
                        >
                          {isEnrolled ? (
                            <>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="bg-[#6c63ff] px-6 py-4">
                <div className="flex items-center space-x-3">
